...
def main():
	...
	cached_context_features_dir = './data/trainval_referit_local_features/'
	imlist = io.load_str_list('./data/training/trainval_imcrop_list.txt')
	num_im = len(imlist)
	print("number of training crops:", num_im)
