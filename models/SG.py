...
class Model():
    '''
    This is the implementation for the SG model. you can add Batch Normalization
    layer over the image/language domaine (see bnorm_attention method). 
    '''
    def __init__(self,
                 batch_size, 
                 num_hidden, 
    ...
    def length(self, seq):
        '''
        Returns real lengths (before addings) of all queries in seq  .
        '''
