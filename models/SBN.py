...
class Model():
    '''
    This is the implementation for SG+SBN (Supervised GroundeR with Scaled Batch Normalization).
    The implementation is similar to SG, however, we scale the image and language BN outputs by
    IMGscale and Qscale respectievly. In addition we've also calculate the update rates of the two domins.
    '''
    def __init__(self,
                 batch_size, 
                 num_hidden, 
